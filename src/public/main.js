const SpotifyApp = (function () {
  ...
  const apiEndpoints = {
    createPlaylist:
      "https://setlistfm-to-spotify.onrender.com/api/create-playlist",
    manualCreatePlaylist:
      "https://setlistfm-to-spotify.onrender.com/api/manual-create-playlist",
    manualSubmitPlaylist:
      "https://setlistfm-to-spotify.onrender.com/api/manual-submit-playlist",
  };
  ...
  function manualCreatePlaylistSubmit() {
    ...
    const trackIds = Array.from(
      document.querySelectorAll(".track-checkbox:checked")
