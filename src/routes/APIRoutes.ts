...
class APIRoutes {
	...
	private initRoutes(): void {
		this.router.get('/callback', (req: Request, res: Response) => this.apiController.loginCallback(req, res));

		this.router.post('/create-playlist', async (req: Request, res: Response) =>
			this.apiController.createPlaylist(req, res)
		);

		this.router.post('/manual-create-playlist', async (req: Request, res: Response) =>
			this.apiController.manualCreatePlaylist(req, res)
		);

		this.router.post('/manual-submit-playlist', async (req: Request, res: Response) =>
